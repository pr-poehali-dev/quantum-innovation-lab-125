  ...
  const Field = ({
    ...
    <div>
      ...
      <input
        ...
        className={`w-full px-4 py-3 rounded-xl border bg-secondary/50 text-sm outline-none transition-all focus:bg-card ${
            ...
            <>
              ...
              <div className="px-7 py-6 space-y-4">
                ...
                <button onClick={handleSubmit}
                  className="w-full bg-primary text-primary-foreground py-3.5 rounded-xl font-semibold text-sm hover:bg-primary/90 transition-all hover:shadow-lg hover:shadow-primary/20 flex items-center justify-center gap-2 mt-2">
          ...
          {step === "success" && (
            <div className="px-7 py-12 flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground text-sm max-w-xs leading-relaxed mb-6">
                Менеджер свяжется с вами в течение 30 минут. Пока ждёте — можете заполнить производственный бриф.
              </p>
